...
warnings.filterwarnings("ignore", message=".*Neither PyTorch nor TensorFlow have been found.*")
...
# Option 1: General purpose, not domain specific but good baseline
# MODEL_NAME = "facebook/bart-large-mnli"
# Option 2: DeBERTa fine-tuned on MNLI (natural language inference) - Potentially more domain specific
MODEL_NAME = "MoritzLaurer/DeBERTa-v3-large-mnli-fever-anli-ling-wanli"
# Option 3: Strong general NLI model - Potential third option???
...
infection_labels = [
    "infection mentioned",
    "infection likely due to factors",
...
# Save the results to a new CSV file, including model name
try:
